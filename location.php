                            ...
                            <div class="col-md-6">
                                <div class="location-item">
                                    ...
                                    <div class="location-text">
                                        ...
                                        <p>123 Katipunan Avenue, Quezon City, Metro Manila</p>
                                        <p><strong>Call:</strong> +63 917 800 1234</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="location-item">
                                    ...
                                    <div class="location-text">  
                                    <h3>Car Washing Point</h3>
                                    <p>45 J.P. Rizal Street, Makati City, Metro Manila</p>
                                    <p><strong>Call:</strong> +63 925 600 9876</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="location-item">
                                    ...
                                    <div class="location-text">
                                        <h3>Car Washing Point</h3>
                                        <p>10 Lacson Street, Bacolod City, Negros Occidental</p>
                                        <p><strong>Call:</strong> +63 927 345 1111</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="location-item">
                                    ...
                                    <div class="location-text">
                                        <h3>Car Washing Point</h3>
                                        <p>88 Gov. Duterte Street, Davao City, Davao del Sur</p>
                                        <p><strong>Call:</strong> +63 917 123 4567</p>
                                    </div>
                                </div>
                            </div>
                        </div>
